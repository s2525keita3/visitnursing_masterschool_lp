...
const ContactForm = () => {
  ...
  return (
    <Section id="contact" tone="surface">
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 bg-white rounded-3xl border border-brand-dark/10 shadow-card p-10">
        ...
        <div className="flex flex-col gap-3 items-center">
          ...
          {status === "success" && <p className="text-sm font-semibold text-brand-gold">送信が完了しました。24時間以内にご連絡いたします。</p>}
        </div>
      </form>
    </Section>
  );
