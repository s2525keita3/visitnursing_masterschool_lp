  ...
  <Section tone="surface">
    ...
    <div className="grid md:grid-cols-3 gap-6">
      {steps.map((step, index) => (
        <div key={step.title} className="rounded-2xl p-8 border border-brand-dark/10 bg-white shadow-card-soft space-y-4">
    ...
    <div className="rounded-3xl border border-brand-dark/15 bg-white shadow-card p-10 text-center space-y-3">
