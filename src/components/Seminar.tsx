...
const Seminar = () => (
  <Section>
    <div className="rounded-3xl bg-white shadow-card border border-brand-dark/10 p-10 space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-4 text-brand-dark font-semibold">
        <div className="flex items-center gap-3 justify-center border border-brand-dark/10 rounded-2xl px-4 py-3">
