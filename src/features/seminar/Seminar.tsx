...
const Seminar = () => (
  <Section>
    <div className="rounded-3xl bg-white shadow-card hover-lift border border-brand-dark/5 p-10 space-y-8 animate-fade-up">
      ...
      <div className="grid md:grid-cols-3 gap-4 text-brand-dark font-semibold">
        <div className="flex items-center gap-3 justify-center border border-brand-dark/5 rounded-3xl px-4 py-3 shadow-card hover-lift bg-white">
